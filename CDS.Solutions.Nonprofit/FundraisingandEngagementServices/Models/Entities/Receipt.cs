...
namespace FundraisingandEngagement.Models.Entities
{
    ...
    public partial class Receipt : PaymentEntity, IContactPaymentEntity, IIdentifierEntity
    {
        ...
        [EntityNameMap("msnfp_ReceiptNumber")] public string ReceiptNumber { get; set; }
        ...
        [EntityNameMap("msnfp_ReceiptStatus")] public string ReceiptStatus { get; set; }

        //[EntityOptionSetMap("msnfp_Amount_Receipted")]
        public decimal? AmountReceipted { get; set; }

        [EntityNameMap("msnfp_Identifier")] public string Identifier { get; set; }

        [EntityNameMap("msnfp_Amount")]
        [Column(TypeName = "money")]
        public decimal? Amount { get; set; }

        [EntityNameMap("msnfp_Printed")] public DateTime? Printed { get; set; }
